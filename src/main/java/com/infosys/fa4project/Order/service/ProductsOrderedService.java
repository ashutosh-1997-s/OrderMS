package com.infosys.fa4project.Order.service;
...
import com.infosys.fa4project.Order.dto.ProductsOrderedDTO;
import com.infosys.fa4project.Order.entity.ProductsOrdered;
import com.infosys.fa4project.Order.repository.ProductsOrderedRepository;
...
public class ProductsOrderedService {
	...
	public List<ProductsOrderedDTO> getSpecificProductsOrdered(int prodId) {
		...
		List<ProductsOrderedDTO> productsOrderedDTOList = new ArrayList<>();
		List<ProductsOrdered> productsOrderedList = productsOrderedRepo.findByProductsOrderedPkProdId(prodId);
